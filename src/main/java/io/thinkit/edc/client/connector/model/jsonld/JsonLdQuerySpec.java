...
public class JsonLdQuerySpec extends JsonLdObject implements QuerySpec {
    ...
    private JsonLdQuerySpec(JsonObject raw) {
        super(raw);
    }
    ...
    public static final class Builder extends AbstractBuilder<JsonLdQuerySpec, JsonLdQuerySpec.Builder> {
        public static Builder newInstance() {
            return new Builder();
        }

        public JsonLdQuerySpec build() {
            return new JsonLdQuerySpec(builder.add(TYPE, TYPE_QUERY_SPEC).build());
        }
